        ...
        return (
            <div className="toolkit-item">
                <form onSubmit={(evt) => evt.preventDefault()}>
                    ...
                    <label>
                        Measure unit:
                        <input type="text" name="measureUnit" value={this.state.measureUnit}
                               onChange={this.handleChange} required/>
                    </label>
                    <label>
                        Price:
                        <input type="number" name="price" step={0.10} value={this.state.price}
                               onChange={this.handleChange} required/>
                    </label>
                    <label>
                        Description:
                    ...
                    <input type="submit" className="button success item-adder-button" onClick={this.addItem}
                           value="ADD ITEM"/>
                </form>
            </div>
