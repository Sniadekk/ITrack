                ...
                {this.state.menuToggled &&
                    <div>
                        ...
                        <div tabIndex="0" onKeyDown={this.removeMenu} className="menu">
                            ...
                            <input type="number" name="amount" value={this.state.json.amount} onChange={this.handleChange}/>
                            </label>
                            <label>
                                <span className="menu-item"> Price: </span>
                            <input type="number" name="price" value={this.state.json.price} onChange={this.handleChange}/>
                            </label>
                            <label>
                                <span className="menu-item"> Description: </span>
                            <textarea name="description" value={this.state.json.description} onChange={this.handleChange}/>
                            </label>
                            <div className="menu-buttons">
                                ...
                                <button onClick={this.updateItem} className="button success"><span className="icon-pencil" aria-hidden="true">EDIT</span></button>
